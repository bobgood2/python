...
// Disable requirement for this.
#pragma warning disable IDE0009 // Or IDE0009
// Disable requirement that function names use CammelCase
#pragma warning disable IDE1006 // Or IDE0009
// Disable unused constructor arguments
#pragma warning disable IDE0060 // Or IDE0009
...
namespace Antlr4.Runtime
{
    ...
    public abstract partial class Python3LexerBase : Lexer
    {
        ...
        {
            var dedent = CommonToken(Python3Lexer.DEDENT, string.Empty);
        ...
        {
            var newLine = NonNewLineRegex().Replace(Text, string.Empty);
            var spaces = NewLineRegex().Replace(Text, string.Empty);
